...
latex_documents = [
  ('index', 'Symfony.tex', u'Documentação do Symfony',
   u'Comunidade do Symfony', 'manual'),
]
...
man_pages = [
    ('index', 'symfony', u'Documentação do Symfony',
     [u'Comunidade do Symfony'], 1)
]
...
texinfo_documents = [
  ('index', 'Symfony', u'Documentação do Symfony',
   u'Comunidade do Symfony', 'Symfony', 'Documentação do Symfony.',
   'Miscelânea'),
]
